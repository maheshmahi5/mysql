...
//4. Do all of the names contain vowels?
 var z=names.every(function(name){
    return name.indexOf("a")!= -1||name.indexOf("e")!= -1||name.indexOf("i")!= -1||
                name.indexOf("o")!= -1||name.indexOf("u")!= -1
    });
    console.log(z);


//5. Are there any names that have only two letters?
var z=names.some(function(name){
...
var z=names.reduce(function(name1,name2){
